...
2. Otoworzyć kolejne okno terminalu i wpisać komendę "rosrun turtlesim turtlesim_node" , powinno pojawić się nowe okno z niebieską planszą, na środku której powinien być żółw(jego wygląd jest losowy)
...
Aby zakonczyc nalezy wpisac w terminalu Matlab komende rosshutdown oraz zamknac wszystkie terminale.
